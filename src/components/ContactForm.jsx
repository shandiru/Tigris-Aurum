      ...
      <div className="relative z-10 max-w-3xl mx-auto pt-10">
        <div className="rounded-[28px] border border-[#E6D39C] bg-white/92 p-6 md:p-8 shadow-[0_20px_60px_rgba(26,26,26,0.12)] backdrop-blur-sm">
            ...
            {["name", "email", "phone"].map((field) => (
              <div key={field}>
                <input
                  ...
                  className={`w-full bg-[#FCFAF5] border ${errors[field] ? 'border-red-500' : 'border-[#D8C28A]'} text-[#1A1A1A] rounded-lg p-3 outline-none`}
                />
              </div>
            ))}
          </div>
          ...
          <div className="space-y-4">
            {menuItems.map((m, i) => (
              <div key={m.id} className="rounded-2xl border border-[#E9DDB7] bg-[#FCFAF5] p-4">
                ...
                <select
                  ...
                  className="w-full mb-2 bg-white border border-[#D8C28A] text-[#1A1A1A] rounded-lg p-2"
                >
                ...
                <select
                  ...
                  className="w-full mb-2 bg-white border border-[#D8C28A] text-[#1A1A1A] rounded-lg p-2 disabled:opacity-50"
                >
                ...
                <input
                  ...
                  className="w-24 bg-white border border-[#D8C28A] text-[#1A1A1A] rounded-lg p-2"
                />
              </div>
            ))}
          </div>

          <button onClick={addMenuItem} className="w-full mt-4 bg-[#C9A84C] text-[#1A1A1A] py-3 rounded-lg font-semibold">
